...
st.markdown("<h1 style = 'color: #3652AD; text-align: center; font-family:Copperplate Gothic '>EXPRESSO CHURN PREDICTOR</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #280274; text-align: center; font-family: Copperplate Gothic'> By REEDA: Daintree Cohort </h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html= True)

st.image('pngwing.com (6).png', width = 700)
